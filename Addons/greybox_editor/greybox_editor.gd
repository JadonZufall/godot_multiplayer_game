...
const EDITOR_SCENE: PackedScene = preload("res://Addons/greybox_editor/greybox_editor.tscn")
...
func _enter_tree() -> void:
	...
	add_tool_menu_item("Open Greybox Editor", Callable(self, "_on_open_editor_window"))

func _on_open_editor_window() -> void:
	editor_instance.popup_centered()

func _exit_tree() -> void:
	remove_tool_menu_item("Open Greybox Editor")
